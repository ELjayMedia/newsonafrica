...
const WORDPRESS_API_URL =
  process.env.NEXT_PUBLIC_WORDPRESS_API_URL || 'https://newsonafrica.com/sz/graphql';
const WORDPRESS_REST_API_URL =
  process.env.WORDPRESS_REST_API_URL || 'https://newsonafrica.com/sz/wp-json/wp/v2';
 ...
 */
export async function optimizedWordPressSearch(
  query: string,
