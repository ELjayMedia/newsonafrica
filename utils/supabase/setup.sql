...
-- ================================================================
-- ADMIN AND MODERATOR UTILITIES
-- ================================================================

-- Helper function to check admin status based on the profiles table
...
-- Admins bypass RLS on key tables
...
CREATE POLICY "Admins can manage all comment reactions"
...
-- Moderators are allowed to update or delete comments
