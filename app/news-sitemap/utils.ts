...
import { DEFAULT_COUNTRY, getCanonicalArticlePath } from "@/lib/utils/routing"
...
export const buildNewsUrlElement = (
  ...
  const loc = `${baseUrl}${getCanonicalArticlePath({ slug: post.slug, databaseId: post.databaseId }, countryCode)}`
