...
export default function TermsOfService() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        The content on our website is protected by copyright. You may not use, reproduce,
      ...
      <p className="mb-4">
        We may suspend or stop providing our Services to you if you do not comply with our terms or
      ...
      <p className="mb-4">
        When permitted by law, News On Africa will not be responsible for lost profits, revenues, or
