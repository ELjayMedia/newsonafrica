    ...
    return (
      <div className="p-6 bg-white rounded-lg shadow-sm max-w-2xl mx-auto mt-8">
        ...
        <p className="text-gray-700 mb-4">
          We encountered a problem loading this category: {(error as Error).message}
        </p>
        <button
  ...
  return (
    <ErrorBoundary>
      ...
      <div className="space-y-8 px-4 py-8">
        ...
        {/* Featured Posts Grid */}
        {featuredPosts.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
          .length > 0 && (
          <section>
            <h2 className="text-2xl font-bold mb-6">Featured Stories</h2>
            <NewsGrid
              posts={featuredPosts.sort(
                (a, b) => new Date(b.date).getTime() - new Date(a.date).getTime(),
              )}
              layout="vertical"
            />
        ...
        {isFetchingNextPage && (
          <div className="flex justify-center py-8">
            <div className="animate-pulse flex space-x-4">
              ...
              <div
                className="h-3 w-3 bg-gray-400 rounded-full animate-bounce"
