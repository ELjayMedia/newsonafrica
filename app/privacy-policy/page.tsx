...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        This Privacy Policy describes how News On Africa ("we", "us", or "our") collects, uses, and shares your personal
      ...
      <p className="mb-4">
        You have the right to access, correct, or delete your personal information. You can also opt out of certain data
        collection and use.
      </p>
      ...
      <p className="mb-4">
        If you have any questions about this privacy policy, please contact us at privacy@newsonafrica.com.
      </p>
