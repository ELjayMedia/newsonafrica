...
const ResponsiveReturnButton = dynamic(() => import("./ResponsiveReturnButton"), {
  ssr: false,
  loading: () => (
    <div className="px-6 py-3 bg-gray-200 text-gray-400 font-medium rounded-md animate-pulse">Loading...</div>
  ),
})
...
export default function ClientMediaQueryWrapper({ type, query, children }: ClientMediaQueryWrapperProps) {
