...
export function NotificationBell() {
  const { notifications, notificationCount, markAsRead, markAllAsRead, deleteAllNotifications, fetchNotifications } =
    useNotifications()
    ...
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      ...
      <DropdownMenuContent align="end" className="w-80">
        <div className="flex items-center justify-between p-4">
          ...
          <Button variant="ghost" size="sm" onClick={markAllAsRead} disabled={notificationCount.unread === 0}>
            Mark all as read
          </Button>
        </div>
        <DropdownMenuSeparator />
