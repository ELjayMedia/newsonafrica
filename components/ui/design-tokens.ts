...
export const componentStyles = {
  ...
  cardInteractive: combineTokens(designTokens.components.card.interactive, designTokens.colors.states.focus),
  ...
  // Image containers
  imageContainer: combineTokens(designTokens.layout.position.relative, "overflow-hidden", designTokens.radius.md),
