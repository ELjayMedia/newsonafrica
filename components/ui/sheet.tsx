...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg opacity-0 transition-transform transition-opacity duration-300 ease-in-out data-[state=open]:opacity-100 data-[state=closed]:opacity-0",
  {
    variants: {
      side: {
