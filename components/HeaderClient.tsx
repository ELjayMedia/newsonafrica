...
interface HeaderClientProps {
  categoriesByCountry: Record<string, WordPressCategory[]>
}

export function HeaderClient({ categoriesByCountry }: HeaderClientProps) {
  ...
  const categories = categoriesByCountry[currentCountry] || []
